...
class TodoItemsModel extends BaseModel
{
    ...
    public function getTodoItemBySearch($search) {
        ...
        $stmt->bindValue(':family_name', "%$search%", PDO::PARAM_STR);
        $stmt->bindValue(':first_name', "%$search%", PDO::PARAM_STR);
        $stmt->bindValue(':registration_date', $search, PDO::PARAM_STR);
        $stmt->bindValue(':expire_date', $search, PDO::PARAM_STR);
    ...
    public function updateTodoItemById($data) {
        ...
        $stmt->bindValue(':expire_date', $data['expire_date'], PDO::PARAM_STR);
        $stmt->bindValue(':finished_date', $data['finished_date'], PDO::PARAM_STR);
        $stmt->bindValue(':is_deleted', $data['is_deleted'], PDO::PARAM_INT);
